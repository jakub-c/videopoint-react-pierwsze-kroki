...
Nowy polecany terminal dla Windows znajduje się tutaj: https://github.com/microsoft/terminal

- podczas kursu mówiłem on narzędziu Cmder, który zastępował domyślny terminal dla Windows
- od tamtego czasu Microsoft stworzył swój własny nowy terminal (link + instrukcja instalacji powyżej)
  - program można nawet pobrać z Windows Store
- uczestnikom kursu polecam zatem nowy Windows Terminal
  - jeśli, ktoś ma inne preferencje oczywiście nie będzie to przeszkodą w ukończeniu kursu
